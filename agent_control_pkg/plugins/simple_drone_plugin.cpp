...
namespace gazebo
{
  ...
  private:
    ...
    void OnWindVelocity(const geometry_msgs::msg::Vector3::SharedPtr msg)
    {
      ...
      // Z component ignored for 2D simulation
    }
     ...
     *
     * Converts wind force to constant acceleration bias for physics core.
     * This models unmodeled forces or constant disturbances.
     *
     * Topic: /wind/force
     * Message format: geometry_msgs/Vector3
